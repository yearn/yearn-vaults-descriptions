				...
				<div className={'flex flex-row space-x-2 h-full'}>
					<div className={'items-center justify-start flex-row flex h-full'} key={routerMapping[router.pathname]}>
						<select
							...
							className={'m-0 mr-2 px-3 py-2 items-center leading-4 cursor-pointer whitespace-nowrap border border-solid border-ygray-500 dark:border-dark-400 text-xs bg-white dark:bg-dark-400 font-semibold text-ygray-700 dark:text-dark-white pr-7 hidden md:flex'}
							onChange={e => {
